		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						<label for="edit-marketActivityOwner" class="col-sm-2 control-label">所有者<span style="font-size: 15px; color: #006aff;">*</span></label>
						<div class="col-sm-10" style="width: 300px;">
						...
						<label for="edit-marketActivityName" class="col-sm-2 control-label">名称<span style="font-size: 15px; color: #5900ff;">*</span></label>
						<div class="col-sm-10" style="width: 300px;">
